    ...
    <div>
      <div className="bg-slate-900 border-b border-slate-600 flex">
        ...
        <div className="hidden md:flex md:w-full md:justify-between">
          <div className="ml-10">
            <button className="upsideCategory">
              Companies
            </button>
            <button className="upsideCategory">
              Tasks
        ...
        <div className="flex w-full justify-end md:hidden">
          <button onClick={handleClickMenu} className="btnAccent bg-cyan-800 rounded-full px-8">
            {isMenu ? "Close" : "Menu"}
          </button>
        </div>
      </div>
      <div className="md:hidden">
        <div className={isMenu ? "" : "hidden"}>
          <div className="flex flex-col text-2xl bg-slate-900">
            <button className="upsideCategory text-3xl border-b-4 py-4 pd-3 border-slate-600">Companies</button>
            <button className="upsideCategory text-3xl border-b-4 py-4 pd-3 border-slate-600">Tasks</button>
            <button className="upsideCategory text-3xl border-b-4 py-4 pd-3 border-slate-600">Community</button>
          </div>
          <div className="py-8 flex justify-center" onClick={handleClickMenu}>
            <ToLoginButton text="logout" style="bg-cyan-800 px-14 py-3 rounded-full text-slate-200 hover:border-0 hover:bg-sky-900" />
          </div>
        </div>
      </div>
    </div>
