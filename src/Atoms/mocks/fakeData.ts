...
export const fakeUserData: User[] = [
  ...
  },
  {
    ...
    country: "Germany",
    address: "Gotzkowskystrasse 79, 72147 Nehren",
  ...
  },
  {
    ...
    country: "Germany",
    address: "Esplanade 22, 93356 Teugn",
  ...
  },
  {
    ...
    country: "Sweden",
    address: "Alingsåsvägen 50, 513 00  FRISTAD",
  ...
  },
  {
    ...
    country: "Iceland",
    address: "Hverfisgata 53, 801 Selfoss",
    phoneNumber: "489 7002",
    languages: ["en"],
    programLanguages: ["Java"],
    status: UserStatus.FindNewJob,

    taskCompleted: ["Java", "Typescript"],
    taskNotFinished: ["Haskell"],
  },
  {
    id: 10,
    ...
    country: "Italy",
    address: "Via Silvio Spaventa, 72, 06040-Sant'Angelo In Mercole PG",
